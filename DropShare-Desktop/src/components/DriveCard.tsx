        ...
        drives.map(({ name, drive, total, free }, index) => {
          ...
          return (
            <div
              ...
              className={`flex hover:scale-105 duration-300 hover:border-2 hover:shadow-2xl gap-3 cursor-pointer flex-col rounded-xl min-h-48 justify-between p-4 ${colorScheme == "dark" ? "border-[#308ffc] shadow-[#308ffc]" : "border-blue-400 shadow-blue-400"}`}
              style={{
                backgroundColor: Colors[colorScheme].transparent,
              }}
            >
